...
public class HashtagSplitterBolt implements IBasicBolt {
	...
	public void declareOutputFields(OutputFieldsDeclarer declarer) {
		declarer.declareStream("hashtags", new Fields("txid", "tweet_id",
				"hashtag"));
	}
	...
	public void execute(Tuple input, BasicOutputCollector collector) {
		...
		TransactionAttempt tx = (TransactionAttempt) input
				.getValueByField("txid");
		HashSet<String> words = new HashSet<String>();

		while (strTok.hasMoreTokens()) {
			String word = strTok.nextToken();

			// Ensure that the current word is a hashtag, and that it's not
