...
// do this with TestWordSpout(). This example doesnt exist
// Difference between OutputCollector and BatchOutputCollector?
// what part is stored in Zookeeper as metadata? there is no transaction id like in redis? 
// 
public class TestSimpleTransaction {
	...
	//what is the difference between BaseBatchBolt and BaseRichBolt?
	//not a stupid answer like one has finishBatch()
	public static class TestSimpleTransactionBolt extends BaseBatchBolt{
		...
		public void finishBatch() {
			// TODO Auto-generated method stub
			LOG.info("first bolt finish batch:"+id+" count:"+count);
	...
	public static class TestSimpleTransactionCommitterBolt extends BaseTransactionalBolt implements ICommitter{
		...
		public void finishBatch() {
			// TODO Auto-generated method stub
			LOG.info("committer bolt finishBatch!!!!!!!!!!!!!!!!!!!!!!");
			...
			LOG.info("finish Batch collector emit attempt:"+attempt+" newValCount:"+newVal.count);
		...
		public void declareOutputFields(OutputFieldsDeclarer declarer) {
			// TODO Auto-generated method stub
			// we should see "id", "sum" as the output!!! where is this? 
			// this should correlate with attempt/newVal.count
	...
	public static void main(String []args){
		try{
			...
			builder.setBolt("sum", new TestSimpleTransactionCommitterBolt()).globalGrouping("partial-count");
